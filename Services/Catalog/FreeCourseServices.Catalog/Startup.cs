...
namespace FreeCourseServices.Catalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //appsetting.json'ý okur. Herhangi bir class'ýn constructorýnda ioptions ile kullanabiliriz böylece DatabaseSettings o class içerisinde dolu bir þekilde gelecek
